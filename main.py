...
VERSION = "v2.7.0-cap0125-llm-developer-bridge"
...
RUNTIME_STATE: Dict[str, Any] = {
    "system": "AI_OS",
    "version": VERSION,
    "stage": "CAP-012.5 LLM Developer Bridge",
    "last_stable_cap": "CAP-012.4",
    "current_cap": "CAP-012.5",
    "current_task": "Prepojiť AI_OS s AnythingLLM / externým LLM vývojárom bezpečným mostom.",
