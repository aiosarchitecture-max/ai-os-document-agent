...
APP_NAME = "AI_OS_ORCHESTRATOR_V1_4_7_ASSISTANT_LAUNCH_STABLE"
VERSION = "1.4.7-assistant-launch-stable"
...
def call_apps_script(title: str, content: str, folder_id: Optional[str], rid: str) -> Dict[str, Any]:
    ...
    print("=============================")
        try:
            ...
            data = {"status": "error", "code": "NON_JSON_APPS_SCRIPT_RESPONSE", "raw": r.text[:2000]}
        ...
        return {"status": "error", "code": e.__class__.__name__, "details": str(e)[:2500]}
